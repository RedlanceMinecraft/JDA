...
public class JDABuilder {
    ...
    public static JDABuilder create(
            @Nonnull AccountType type, @Nullable String token, @Nonnull GatewayIntent intent, @Nonnull GatewayIntent... intents) {
    ...
    public JDA build(boolean verifyToken) {
        ...
        JDAImpl jda =
                new JDAImpl(authConfig, sessionConfig, threadingConfig, metaConfig, restConfig, audioModuleConfig, platform);
